...
const LinearCallRecordCircle = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
    }) => <Svg height={size} width={size} fill="none" viewBox="0 0 24 24" strokeWidth={stroke} xmlns="http://www.w3.org/2000/svg" {...props}>
	<Path d="M18.5002 11.9999C18.5002 13.3807 17.3809 14.4999 16.0002 14.4999C14.6195 14.4999 13.5002 13.3807 13.5002 11.9999C13.5002 10.6192 14.6195 9.49994 16.0002 9.49994C17.3809 9.49994 18.5002 10.6192 18.5002 11.9999Z" stroke="black" strokeWidth="1.5"/>
...
export default LinearCallRecordCircle;
