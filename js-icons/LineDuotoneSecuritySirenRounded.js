...
const LineDuotoneSecuritySirenRounded = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
    }) => <Svg height={size} width={size} fill="none" viewBox="0 0 24 24" strokeWidth={stroke} xmlns="http://www.w3.org/2000/svg" {...props}>
	<Path d="M20 22V16C20 11.5817 16.4183 8 12 8C7.58172 8 4 11.5817 4 16V22" opacity="0.5" stroke="black" strokeWidth="1.5"/>
...
export default LineDuotoneSecuritySirenRounded;
