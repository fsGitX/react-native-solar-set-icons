...
const LinearSchoolBookBookmarkMinimalistic = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M7 16V2.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default LinearSchoolBookBookmarkMinimalistic;
