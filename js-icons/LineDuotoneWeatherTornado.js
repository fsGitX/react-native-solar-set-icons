...
const LineDuotoneWeatherTornado = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M20 8C20 8 17.2089 9 11.7241 9C6.23938 9 4 8 4 8" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M16 14C16 14 14.7424 14.5 12 14.5C9.25762 14.5 8 14 8 14" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	...
	<Path d="M11.7188 19.4609C12.103 19.4853 12.5297 19.5 13.0002 19.5C13.5738 19.5 14.0662 19.456 14.5002 19.3857" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default LineDuotoneWeatherTornado;
