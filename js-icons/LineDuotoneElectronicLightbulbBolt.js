...
const LineDuotoneElectronicLightbulbBolt = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M12.7856 8.5L10.6427 11.5H13.6427L11.4999 14.5" opacity="0.5" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/>
</Svg>;

export default LineDuotoneElectronicLightbulbBolt;
