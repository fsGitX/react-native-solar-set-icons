...
const LineDuotoneVideoVideoFrame = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M17 2.5V21.5M7 2.5V21.5M2.5 7H7M17 7H21.5M17 17H21.5M2.5 17H7M2 12H22" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
</Svg>;

export default LineDuotoneVideoVideoFrame;
