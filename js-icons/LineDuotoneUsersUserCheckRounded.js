...
const LineDuotoneUsersUserCheckRounded = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M15.6665 18.0002L16.5 19.0002L18.3332 17.1113" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/>
...
export default LineDuotoneUsersUserCheckRounded;
