...
const BoldDuotoneEssentionalHome2 = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M11.25 18C11.25 18.4142 11.5858 18.75 12 18.75C12.4142 18.75 12.75 18.4142 12.75 18V15C12.75 14.5858 12.4142 14.25 12 14.25C11.5858 14.25 11.25 14.5858 11.25 15V18Z" fill={color}/>
</Svg>;

export default BoldDuotoneEssentionalHome2;
