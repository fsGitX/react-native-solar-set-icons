...
const LineDuotoneElectronicSocket = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M12 18.0001V16.5" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M12 7.5V6" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<circle cx="12" cy="12" r="6" stroke="black" strokeWidth="1.5"/>
	<circle cx="14" cy="12" fill={color} r="1"/>
	<circle cx="10" cy="12" fill={color} r="1"/>
</Svg>;

export default LineDuotoneElectronicSocket;
