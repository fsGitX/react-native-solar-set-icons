...
const LinearTimeHistory2 = ({
	...
	<circle cx="12" cy="12" r="10" stroke="black" strokeDasharray="0.5 3.5" strokeLinecap="round" strokeWidth="1.5"/>
</Svg>;

export default LinearTimeHistory2;
