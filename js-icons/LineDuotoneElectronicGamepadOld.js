...
const LineDuotoneElectronicGamepadOld = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
...
export default LineDuotoneElectronicGamepadOld;
