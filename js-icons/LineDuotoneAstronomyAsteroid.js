...
const LineDuotoneAstronomyAsteroid = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M2.08545 13.312C2.68675 13.1097 3.33065 13 4.00015 13C7.31386 13 10.0002 15.6863 10.0002 19C10.0002 19.9529 9.77804 20.8538 9.38276 21.654" opacity="0.5" stroke="black" strokeWidth="1.5"/>
	<Path d="M21.8227 13.8846C19.0727 13.3375 17 10.9108 17 8.00008C17 6.58023 17.4932 5.27556 18.3176 4.24805" opacity="0.5" stroke="black" strokeWidth="1.5"/>
...
export default LineDuotoneAstronomyAsteroid;
