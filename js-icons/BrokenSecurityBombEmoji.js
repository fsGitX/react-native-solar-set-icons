...
const BrokenSecurityBombEmoji = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
    }) => <Svg height={size} width={size} fill="none" viewBox="0 0 24 24" strokeWidth={stroke} xmlns="http://www.w3.org/2000/svg" {...props}>
	<Path d="M10 16L12 16" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M14 12.5C14 13.3284 13.5523 14 13 14C12.4477 14 12 13.3284 12 12.5C12 11.6716 12.4477 11 13 11C13.5523 11 14 11.6716 14 12.5Z" fill={color}/>
	...
	<ellipse cx="9" cy="12.5" fill={color} rx="1" ry="1.5"/>
</Svg>;

export default BrokenSecurityBombEmoji;
