...
const BoldDuotoneTimeAlarmRemove = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M15 12.25C15.4142 12.25 15.75 12.5858 15.75 13C15.75 13.4142 15.4142 13.75 15 13.75L9 13.75C8.58579 13.75 8.25 13.4142 8.25 13C8.25 12.5858 8.58579 12.25 9 12.25L15 12.25Z" fill={color}/>
...
export default BoldDuotoneTimeAlarmRemove;
