...
const BrokenEssentionalDatabase = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M20 12L20 18" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	...
	<Path d="M20 12C20 14.2091 16.4183 16 12 16C7.58172 16 4 14.2091 4 12" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M20 18C20 20.2091 16.4183 22 12 22C7.58172 22 4 20.2091 4 18" stroke="black" strokeWidth="1.5"/>
</Svg>;

export default BrokenEssentionalDatabase;
