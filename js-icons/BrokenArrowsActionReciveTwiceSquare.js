...
const BrokenArrowsActionReciveTwiceSquare = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M17 6L17 18" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default BrokenArrowsActionReciveTwiceSquare;
