...
const LinearEssentionalMenuDotsSquare = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
    }) => <Svg height={size} width={size} fill="none" viewBox="0 0 24 24" strokeWidth={stroke} xmlns="http://www.w3.org/2000/svg" {...props}>
	<Path d="M8 12H8.00901M12.0045 12H12.0135M15.991 12H16" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
...
export default LinearEssentionalMenuDotsSquare;
