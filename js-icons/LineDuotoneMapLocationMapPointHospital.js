...
const LineDuotoneMapLocationMapPointHospital = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M10.5 10H13.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M12 11.5L12 8.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<circle cx="12" cy="10" r="4" stroke="black" strokeWidth="1.5"/>
</Svg>;

export default LineDuotoneMapLocationMapPointHospital;
