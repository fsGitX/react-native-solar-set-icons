...
const BrokenSportsBodyShapeMinimalistic = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M6 13H11M18 13H15" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default BrokenSportsBodyShapeMinimalistic;
