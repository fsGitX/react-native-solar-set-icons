...
const LineDuotoneElectronicTurntableMusicNote = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12Z" opacity="0.5" stroke="black" strokeWidth="1.5"/>
	<circle cx="17" cy="20" r="2" stroke="black" strokeWidth="1.5"/>
</Svg>;

export default LineDuotoneElectronicTurntableMusicNote;
