...
const LinearHomeSmartVacuumCleaner = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M7.49957 20.7361C6.96882 21.2111 6.26793 21.5 5.49957 21.5C3.84272 21.5 2.49957 20.1569 2.49957 18.5C2.49957 17.7316 2.78843 17.0308 3.26347 16.5" stroke="black" strokeWidth="1.5"/>
	<Path d="M12 18V16" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
</Svg>;

export default LinearHomeSmartVacuumCleaner;
