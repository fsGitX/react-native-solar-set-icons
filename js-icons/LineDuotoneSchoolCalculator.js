...
const LineDuotoneSchoolCalculator = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M7 8C7 7.53501 7 7.30252 7.05111 7.11177C7.18981 6.59413 7.59413 6.18981 8.11177 6.05111C8.30252 6 8.53501 6 9 6H15C15.465 6 15.6975 6 15.8882 6.05111C16.4059 6.18981 16.8102 6.59413 16.9489 7.11177C17 7.30252 17 7.53501 17 8C17 8.46499 17 8.69748 16.9489 8.88823C16.8102 9.40587 16.4059 9.81019 15.8882 9.94889C15.6975 10 15.465 10 15 10H9C8.53501 10 8.30252 10 8.11177 9.94889C7.59413 9.81019 7.18981 9.40587 7.05111 8.88823C7 8.69748 7 8.46499 7 8Z" opacity="0.5" stroke="black" strokeWidth="1.5"/>
	<circle cx="8" cy="13" fill={color} opacity="0.5" r="1"/>
	<circle cx="8" cy="17" fill={color} opacity="0.5" r="1"/>
	<circle cx="12" cy="13" fill={color} opacity="0.5" r="1"/>
	<circle cx="12" cy="17" fill={color} opacity="0.5" r="1"/>
	<circle cx="16" cy="13" fill={color} opacity="0.5" r="1"/>
	<circle cx="16" cy="17" fill={color} opacity="0.5" r="1"/>
</Svg>;

export default LineDuotoneSchoolCalculator;
