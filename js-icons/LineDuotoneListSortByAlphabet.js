...
const LineDuotoneListSortByAlphabet = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
    }) => <Svg height={size} width={size} fill="none" viewBox="0 0 24 24" strokeWidth={stroke} xmlns="http://www.w3.org/2000/svg" {...props}>
	<Path d="M13 7L3 7" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M10 12H3" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default LineDuotoneListSortByAlphabet;
