...
const LinearTextFormattingTextSelection = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M6 20H18" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M18 4H6" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M20 18L20 6" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M4 6L4 18" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
</Svg>;

export default LinearTextFormattingTextSelection;
