...
const LineDuotoneSportsBodyShape = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M6 13H18" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M6 11H18" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default LineDuotoneSportsBodyShape;
