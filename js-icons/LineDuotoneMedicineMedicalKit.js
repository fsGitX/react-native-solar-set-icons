...
const LineDuotoneMedicineMedicalKit = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M13.5 14H10.5M12 12.5V15.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<circle cx="12" cy="14" opacity="0.5" r="4" stroke="black" strokeWidth="1.5"/>
</Svg>;

export default LineDuotoneMedicineMedicalKit;
