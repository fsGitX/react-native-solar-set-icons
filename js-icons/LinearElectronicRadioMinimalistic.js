...
const LinearElectronicRadioMinimalistic = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M13.5 14H19" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default LinearElectronicRadioMinimalistic;
