...
const BrokenElectronicLightning = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
    }) => <Svg height={size} width={size} fill="none" viewBox="0 0 24 24" strokeWidth={stroke} xmlns="http://www.w3.org/2000/svg" {...props}>
	<Path d="M17.9391 17.6364C17.8624 18.4046 17.689 18.9217 17.2971 19.3077C16.5941 20 15.4627 20 13.2 20H10.8C8.53726 20 7.40589 20 6.70294 19.3077C6 18.6154 6 17.5012 6 15.2727V12.7273C6 10.4988 6 9.38459 6.70294 8.69229C7.40589 8 8.53726 8 10.8 8H13.2C15.4627 8 16.5941 8 17.2971 8.69229C18 9.38459 18 10.4988 18 12.7273V13.9091" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default BrokenElectronicLightning;
