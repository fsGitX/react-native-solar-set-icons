...
const LineDuotoneUsersUserSpeak = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M18 17.5C18 19.9853 18 22 10 22C2 22 2 19.9853 2 17.5C2 15.0147 5.58172 13 10 13C14.4183 13 18 15.0147 18 17.5Z" opacity="0.5" stroke="black" strokeWidth="1.5"/>
...
export default LineDuotoneUsersUserSpeak;
