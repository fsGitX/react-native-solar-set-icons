...
const LineDuotoneElectronicSmartphone2 = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M15 5H9" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<circle cx="12" cy="17" opacity="0.5" r="2" stroke="black" strokeWidth="1.5"/>
</Svg>;

export default LineDuotoneElectronicSmartphone2;
