...
const LinearFacesFaceScanCircle = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M2.20001 10.0002C2.99539 6.08188 6.0818 2.99551 10.0001 2.2002" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default LinearFacesFaceScanCircle;
