...
const BrokenSchoolCalculator = ({
	...
	<circle cx="8" cy="13" fill={color} r="1"/>
	<circle cx="8" cy="17" fill={color} r="1"/>
	<circle cx="12" cy="13" fill={color} r="1"/>
	<circle cx="12" cy="17" fill={color} r="1"/>
	<circle cx="16" cy="13" fill={color} r="1"/>
	<circle cx="16" cy="17" fill={color} r="1"/>
</Svg>;

export default BrokenSchoolCalculator;
