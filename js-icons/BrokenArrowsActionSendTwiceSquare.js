...
const BrokenArrowsActionSendTwiceSquare = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M7 6L7 18" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default BrokenArrowsActionSendTwiceSquare;
