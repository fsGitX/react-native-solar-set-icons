...
const BrokenSchoolBookBookmarkMinimalistic = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M7 16V9M7 2.5V5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default BrokenSchoolBookBookmarkMinimalistic;
