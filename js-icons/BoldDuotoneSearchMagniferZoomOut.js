...
const BoldDuotoneSearchMagniferZoomOut = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M17.1001 18.1224C17.4671 17.809 17.809 17.4671 18.1224 17.1001L21.7887 20.7664C22.071 21.0487 22.071 21.5064 21.7887 21.7887C21.5064 22.071 21.0487 22.071 20.7664 21.7887L17.1001 18.1224Z" fill={color}/>
...
export default BoldDuotoneSearchMagniferZoomOut;
