...
const LinearShoppingBagMusic2 = ({
	...
	<Path d="M13 16V13V10" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M15 12C13.8954 12 13 11.1046 13 10" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<circle cx="11" cy="16" r="2" stroke="black" strokeWidth="1.5"/>
</Svg>;

export default LinearShoppingBagMusic2;
