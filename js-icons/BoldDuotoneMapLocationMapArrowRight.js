...
const BoldDuotoneMapLocationMapArrowRight = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M15.5337 15.3904C15.6534 15.6297 15.9402 15.7324 16.1846 15.6235L21.0071 13.4728C22.3309 12.8825 22.3309 11.1181 21.0071 10.5278L12.1094 6.55983C11.6807 6.36864 11.2486 6.82023 11.4585 7.24008L15.5337 15.3904Z" fill={color} opacity="0.5"/>
</Svg>;

export default BoldDuotoneMapLocationMapArrowRight;
