...
const BoldDuotoneFacesExpressionlessSquare = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M9 16.75C8.58579 16.75 8.25 16.4142 8.25 16C8.25 15.5858 8.58579 15.25 9 15.25H15C15.4142 15.25 15.75 15.5858 15.75 16C15.75 16.4142 15.4142 16.75 15 16.75H9Z" fill={color}/>
...
export default BoldDuotoneFacesExpressionlessSquare;
