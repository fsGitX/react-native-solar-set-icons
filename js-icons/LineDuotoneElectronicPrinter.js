...
const LineDuotoneElectronicPrinter = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M18 14V16C18 18.8284 18 20.2426 17.1213 21.1213C16.2426 22 14.8284 22 12 22C9.17157 22 7.75736 22 6.87868 21.1213C6 20.2426 6 18.8284 6 16V14" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	...
	<Path d="M15 16.5H9" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M13 19H9" opacity="0.5" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<circle cx="17" cy="10" fill={color} opacity="0.5" r="1"/>
</Svg>;

export default LineDuotoneElectronicPrinter;
