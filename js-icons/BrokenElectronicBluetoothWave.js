...
const BrokenElectronicBluetoothWave = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
    }) => <Svg height={size} width={size} fill="none" viewBox="0 0 24 24" strokeWidth={stroke} xmlns="http://www.w3.org/2000/svg" {...props}>
	<Path d="M13.2633 4.6551C14.4211 5.47731 15 5.88842 15 6.45874C15 7.02907 14.4211 7.44017 13.2633 8.26238L8 12V5.22457C8 3.33816 8 2.39496 8.60465 2.08561C8.96658 1.90043 9.38847 2.02253 10 2.38554" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	...
	<Path d="M19 5C19 5 21 7.1 21 12C21 12.7276 20.9559 13.3936 20.8808 14M19 19C19 19 19.3043 18.6805 19.6755 18" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
	<Path d="M17 8C17 8 18 9.9 18 12C18 14.1 17 16 17 16" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
</Svg>;

export default BrokenElectronicBluetoothWave;
