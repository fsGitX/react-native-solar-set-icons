...
const LineDuotoneSearchRoundedMagniferZoomOut = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M9 11H11H13" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default LineDuotoneSearchRoundedMagniferZoomOut;
