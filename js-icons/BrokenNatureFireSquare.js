...
const BrokenNatureFireSquare = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
    }) => <Svg height={size} width={size} fill="none" viewBox="0 0 24 24" strokeWidth={stroke} xmlns="http://www.w3.org/2000/svg" {...props}>
	<Path d="M16.5582 15C16.835 14.3565 17 13.5858 17 12.6666C17 10.0558 15.4593 8.16225 14.0008 7.0316C13.2525 6.45153 12.2941 7.05317 12.2941 7.99995C12.2941 8.64267 12.0054 9.71293 11.4205 10.5011C10.7814 11.3622 9.95616 10.502 9.89841 9.43125C9.87201 8.94186 9.36421 8.76858 8.95593 9.03969C8.06292 9.6327 7 10.8109 7 12.6666C7 16.9333 10.1111 18 11.6667 18C12.474 18 13.648 17.78 14.6891 17.1402" stroke="black" strokeLinecap="round" strokeWidth="1.5"/>
...
export default BrokenNatureFireSquare;
