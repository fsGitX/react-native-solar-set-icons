...
const BrokenElectronicLightbulbBolt = ({
    size = 24,
    color = "#1f2937",
    stroke = 2,
    ...props
	...
	<Path d="M12.7857 8.5L10.6428 11.5H13.6428L11.5 14.5" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/>
</Svg>;

export default BrokenElectronicLightbulbBolt;
